...
class Existing  extends \BoostMyShop\PointOfSales\Block\Widget\Grid
{
    ...
    {
        parent::_construct();
        $this->setId('existingCustomerGrid');
    ...
    {
        return $this->getUrl('*/checkout/customerSearch');
    }
    ...
    {
        return "objPosCheckout.selectCustomer(".$item->getId().")";
    }
